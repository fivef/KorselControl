...
public class KorselBluetoothSerial {
    ...
    //values up to this number are reserved for commands and can't be used as speed value
	...
	public void sendCommand(char command, int value){
    	...
    	try{
    		...
    		System.out.println("System out command: " + command);
	...
	private void setMotorSpeed(char position, int speed){
		...
		//dont' send speeds smaller than RESERVED_FOR_COMMANDS, these values are used for commands
